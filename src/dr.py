...
ax_names = [
	'Train return', 
	'Solved rate: GoalNearMin', 
	'Solved rate: GoalNearMax', 
	'Solved rate: ToughCase', 
	'SPS']
col_names = [
	'return', 
	'eval/a0:test_solved_rate:MountainCar-v0-GoalNearMin', 
	'eval/a0:test_solved_rate:MountainCar-v0-GoalNearMax', 
	'eval/a0:test_solved_rate:MountainCar-v0-ToughCase',
	'sps']
...
# Make student
model = models.make(
	env_name='MountainCar-v0', model_name='default_student_cnn', recurrent_arch='lstm')
...
eval_runner_kwargs = dict(
	...
	env_names="MountainCar-v0-GoalNearMin,MountainCar-v0-GoalNearMax,MountainCar-v0-ToughCase",
